import { getCitiesRepo, getCityByRepo } from '../repositories/cities.repository.js';


export async function getCities() {
    return await getCitiesRepo();
}


export async function getCityBy(id) {
    const city = await getCityByRepo(id);
    if (city.length === 0) {
